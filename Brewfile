...
cask "kitty"
# Fast, native, feature-rich terminal emulator (tip: development build)
cask "ghostty@tip"
...
# CLI visualizations of kubernetes pod and node metrics (https://github.com/bakito/kube-metrics)
tap "bakito/tap"
cask "kube-metrics"
